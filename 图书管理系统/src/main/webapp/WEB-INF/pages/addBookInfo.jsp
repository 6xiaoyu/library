...
<body>
<form id="form" action="${pageContext.request.contextPath}/admin/addBookInfo">
    <div class="form-group">
        <label for="bookId">图书Id</label>
        <input type="text" class="form-control" id="bookId" name="bookId" placeholder="请误输入已有ID或者不输入" onkeyup="value=value.replace(/[^bai(\d)]/g,'')"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea id="introduction" class="form-control" name="introduction" placeholder="请输入详细内容介绍"></textarea>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="price" name="price" onkeyup="value=value.replace(/[^bai(\d)]/g,'')"/>
    </div>
    <div class="form-group">
